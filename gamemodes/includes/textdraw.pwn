...
{
//logo
	LogoSV[0] = TextDrawCreate(7.083335, 469.074127, "VCITY-MU.NET");
	...
	LogoSV[1] = TextDrawCreate(7.333318, 469.777954, "LD_SPAC:white");
...
CreatePokerGUI(playerid)
{
	...
	PlayerPokerUI[playerid][43] = CreatePlayerTextDraw(playerid, 589.000000, 396.000000, "VCITY-MU.NET");
...
public LoadTextDraws()
{
	...
	TextDrawBoxColor(LogoTD[0], -91699713);
	...
	TextDrawBoxColor(LogoTD[1], -91699713);
	...
	TextDrawBoxColor(LogoTD[2], -91699815);
	...
	LogoTD[3] = TextDrawCreate(327.013488, 424.500183, "VCITY-MU.NET");
	...
	NoticeTxtdraw[1] = TextDrawCreate(317.000000, 174.000000, "VCITY-MU.NET - Ket Noi");
	...
	TutTxtdraw[9] = TextDrawCreate(175.000000, 203.000000, "be sure to visit us and sign up on our forums at ~y~www.VCITY-MU.NET~w~ - we");
	...
	TutTxtdraw[12] = TextDrawCreate(175.000000, 255.000000, "check it all out at ~y~VCITY-MU.NET~w~, it helps keep this server up and");
	...
	TutTxtdraw[29] = TextDrawCreate(175.000000, 171.000000, "forums at ~y~www.VCITY-MU.NET~w~.");
	...
	TutTxtdraw[38] = TextDrawCreate(175.000000, 171.000000, "apply on our forums at ~y~www.VCITY-MU.NET~w~.");
	...
	TutTxtdraw[44] = TextDrawCreate(175.000000, 171.000000, "this faction, apply on our forums at ~y~www.VCITY-MU.NET~w~.");
	...
	TutTxtdraw[50] = TextDrawCreate(175.000000, 171.000000, "this faction, apply on our forums at ~y~VCITY-MU.NET~w~.");
	...
	TutTxtdraw[56] = TextDrawCreate(175.000000, 171.000000, "at ~y~www.VCITY-MU.NET~w~.");
	...
	TutTxtdraw[88] = TextDrawCreate(175.000000, 141.000000, "We operate a 24/7 E-Store at ~y~VCITY-MU.NET~w~, you can purchase Vehicles,");
	...
	TutTxtdraw[112] = TextDrawCreate(175.000000, 174.000000, "check out ~y~www.VCITY-MU.NET~w~.");
